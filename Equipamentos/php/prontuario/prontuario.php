    ...
    <body>
        <form action="" method="post">
            ...
            <fieldset id="b">
                ...
                <fieldset id="b-f">
                    <label>Idade:</label>
                    <input type="text" name="idade" size="10" value="<?php echo $paciente->getIdade(); ?>">
                </fieldset>
                <fieldset id="b-g">
                    <label>Hora</label>
            ...
            <fieldset id="c">
                ...
                <fieldset id="c-a">
                    ...
                    <input type="text" name="cartaosus" size="57" value="<?php
            ...
            <fieldset id="d">
                ...
                <fieldset id="d-a">
                    ...
                    <input type="textarea" name="queixaprincipal" size="180" value="<?php echo $triagem->getDsQueixa(); ?>">
                </fieldset>
                <fieldset id="d-b">
