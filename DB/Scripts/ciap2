...
('A79 Carcinomatose (calização primária desconhecida)'),
...
('D81 Malformações congênitasdo aparelho digestivo'),
...
('D94 Enterite crônica / colite ulcerosa'),
...
('F18 Sinais/sintomasrelacionados a lentesde contato'),
...
('K89 Isquemia/ acidente cerebral transitória(''),
...
('L26 Medo de câncer no aparelho músculoesquelético'),
('L27 Medo de doença no aparelho músculoesquelético,outro'),
...
('L71 Neoplasia maligna do aparelho músculoesquelético'),
...
('L82 Malformações congênitas do aparelhomúsculo-esquelético'),
...
('L88 Artrite reumatóide/soropositiva'),
...
('L99 Outra doença doaparelho músculo-esquelético'),
('N01 Cefaléia'),
('N03 Dores da face'),
...
('N76 Neoplasia do sistema neurológico de natureza'),
('N79 Concussão'),
...
('R73 Abscesso/furúnculo no nariz'),
('R74 Infecção aguda do aparelho respiratório superior ('AS)'),
('R75 Sinusite crônica/aguda'),
...
('R89 Malformação congênita do aparelhorespiratório'),
('R90 Hipertrofia das amígdalas/adenóides'),
('R92 Neoplasia respiratória NE'),
('R95 Doença pulmonar obstrutiva crônica'),
('R96 Asma'),
('R97 Rinite alérgica'),
...
('T29 Sinais/sintomas endocrinológicos/metabólicos/nutricionais, outros'),
('T70 Infecção endócrina'),
('T71 Neoplasia maligna da tiroide'),
('T72 Neoplasia benigna da tiroide'),
('T73 Outra neoplasia endócrina NE'),
('T78 Cisto do canal tiroglosso'),
('T80 Malformaçãocongénita endócrina/metabólica'),
('T81 Bócio'),
('T82 Obesidade'),
('T83 Excesso de peso'),
...
('T92 Gota'),
('T93 Alteração no metabolismo dos lipídios'),
...
('U85 Malformação congênita do aparelho urinário'),
('U88 Glomerulonefrite/ síndrome nefrótica'),
...
('Y84 Malformação genital congênita masculina, outra'),
