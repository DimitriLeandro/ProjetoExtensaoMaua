...
-- TABELAS COMPLETAS
select * from tb_paciente order by cd_paciente desc limit 100000;
select * from tb_triagem order by cd_triagem desc limit 100000;
select * from tb_diagnostico order by cd_diagnostico desc limit 100000;
