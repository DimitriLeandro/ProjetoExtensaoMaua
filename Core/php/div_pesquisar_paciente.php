        ...
        while ($stmt->fetch()) {
            ...
            <fieldset id="field_paciente" style="border: solid 1px; padding: 15px;">
                <p>
                    ...
                    <label class="margem">CNS: 
                        <?php
                        //se o CNS for 0, então é pq o paciente não tem CNS. Nesse caso, deve ser exibida a msg de justificativa
                    ...
                    <label class="margem">Idade: <?php echo $paciente->getIdade(); ?></label>
                </p>
                <p>
