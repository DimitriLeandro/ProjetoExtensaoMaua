...
<body>
	...
	<form method="post" id="form_triagem" hidden>	
	</form>
		<div id="div_formulario" class="form-style">
			...
			<!-- input type="submit" id="btn_cadastrar_triagem" value="Enviar e Imprimir"/> -->
			<button type="button" id="btn_a">Enviar e Imprimir</button>
		</div>
	<script>
		$("#btn_a").on("click", function(){
			//criando o iframe dentro da div_body
			$("#div_frame").append("<iframe id='frame_formulario_triagem' name='frame_formulario_triagem' src='#'></iframe>");
			
			//colocando a div dentro do iframe para que ela possa ser impressa e dentro do formulario para que ele possa ser submetido
			$("#div_formulario").clone().appendTo("#frame_formulario_triagem");
			$("#div_formulario").clone().appendTo("#form_triagem");
		...
		{           
			window.frames["frame_formulario_triagem"].focus();
			window.frames["frame_formulario_triagem"].print();
		}
	</script>
</body>
</html>
